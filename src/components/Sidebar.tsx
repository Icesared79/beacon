  ...
  const navContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-beacon-border">
        ...
        <div>
          <p style={{ fontSize: 15, fontWeight: 700, color: 'var(--beacon-text)', lineHeight: 1.2, letterSpacing: '-0.01em' }}>BEACON</p>
          ...
          return (
            <Link
              ...
              style={{
                ...
                padding: '5px 12px',
                borderRadius: 4,
                ...(isActive ? { background: 'var(--beacon-surface-alt)' } : {}),
              }}
              className={cn(
                'flex items-center gap-3 font-medium transition-colors',
                isActive
                  ? 'text-beacon-primary-dark'
